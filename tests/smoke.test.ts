...
import { validateGraphPlaceholder } from '../packages/validator/src/index.js';
...
describe('Yiflow smoke test', () => {
  ...
  it('runs placeholder validation, layout, and rendering', () => {
    const graph = createEmptyGraph('smoke_graph');
    const validation = validateGraphPlaceholder(graph);
